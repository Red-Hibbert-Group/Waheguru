...
export default function ServicesPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-amber-50 to-orange-50 flex items-center">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 lg:py-32 my-8">
        {/* Header Section */}
        <motion.div

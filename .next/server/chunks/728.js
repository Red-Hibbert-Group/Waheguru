...
function Header() {
    ...
    const hasHeroImage = pathname ? pathname === "/faith" || pathname === "/about" || pathname.includes("/services/") : false;
    return /*#__PURE__*/ jsx_runtime_.jsx(proxy/* motion */.E.header, {
        ...
        className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? "bg-neutral-50/95 backdrop-blur-md shadow-md" : hasHeroImage ? "bg-neutral-900/40 backdrop-blur-sm" : "bg-transparent"}`,
                    ...
                    children: [
                        /*#__PURE__*/ jsx_runtime_.jsx((link_default()), {
                            ...
                            children: /*#__PURE__*/ jsx_runtime_.jsx("span", {
                                className: `text-xl font-bold ${isScrolled || !hasHeroImage ? "text-primary-600" : "text-white"}`,
                                children: "Waheguru"
                            })
                        }),
                        /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                            ...
                            children: [
                                navItems.map((item)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)((link_default()), {
                                        href: item.href,
                                        className: `relative px-3 py-2 text-sm font-medium transition-colors ${pathname === item.href ? isScrolled || !hasHeroImage ? "text-primary-600" : "text-primary-400" : isScrolled || !hasHeroImage ? "text-neutral-900 hover:text-primary-600" : "text-white hover:text-primary-300"}`,
                                        children: [
                                            item.name,
                                            pathname === item.href && /*#__PURE__*/ jsx_runtime_.jsx(proxy/* motion */.E.div, {
                                                layoutId: "underline",
                                                className: `absolute left-0 right-0 bottom-0 h-0.5 ${isScrolled || !hasHeroImage ? "bg-primary-600" : "bg-primary-400"}`,
                                                initial: false,
                                                transition: {
                                                    type: "spring",
                                                    stiffness: 300,
                                ...
                                /*#__PURE__*/ jsx_runtime_.jsx((link_default()), {
                                    href: "/donate",
                                    className: "inline-flex items-center justify-center h-10 px-6 font-medium tracking-wide text-white         transition-all duration-300 bg-secondary-500 rounded-lg         hover:bg-secondary-600 hover:shadow-md hover:scale-105",
                                    children: /*#__PURE__*/ jsx_runtime_.jsx("span", {
                        ...
                        /*#__PURE__*/ jsx_runtime_.jsx("button", {
                            ...
                            className: `md:hidden p-2 rounded-md hover:bg-neutral-100 ${isScrolled || !hasHeroImage ? "text-neutral-600 hover:text-primary-600" : "text-white hover:text-primary-300"}`,

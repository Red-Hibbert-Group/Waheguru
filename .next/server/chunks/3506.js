        ...
        return __async(this, arguments, function*(payload, options = {}) {
            ...
            for (const email of payload){
                if (email.react) {
                    if (!this.renderAsync) {
                        try {
                            const { renderAsync } = yield Promise.all(/* import() */[__webpack_require__.e(2947), __webpack_require__.e(7696)]).then(__webpack_require__.bind(__webpack_require__, 77696));
